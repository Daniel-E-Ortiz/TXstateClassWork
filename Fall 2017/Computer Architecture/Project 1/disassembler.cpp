...
void disassembleInstr(uint32_t pc, uint32_t instr) {
  ...
  switch(opcode) {
    case 0x00:
      switch(funct) {
        case 0x00: cout << "sll " << regNames[rd] << ", " << regNames[rs] << ", " << dec << shamt;/* sll */ break;
        case 0x03: cout << "sra " << regNames[rd] << ", " << regNames[rs] << ", " << dec << shamt;/* sra */ break;
        case 0x08: cout << "jr " << regNames[rs];/* jr */ break;
        case 0x10: cout << "mfhi " << regNames[rd];/* mfhi */ break;
        case 0x12: cout << "mflo " << regNames[rd];/* mflo */ break;
        case 0x18: cout << "mult " << regNames[rs] << ", " << regNames[rt];/* mult */ break;
        case 0x1a: cout << "div " << regNames[rs] << ", " << regNames[rt];/* div */ break;
        case 0x21: cout << "addu " << regNames[rd] << ", " << regNames[rs] << ", " << regNames[rt];/* addu */ break;
        case 0x23: cout << "subu " << regNames[rd] << ", " << regNames[rs] << ", " << regNames[rt];/* subu */ break;
        case 0x2a: cout << "slt " << regNames[rd] << ", " << regNames[rs] << ", " << regNames[rt];/* slt */ break;
        default: cout << "unimplemented";
      }
      break;
    case 0x02: cout << "j " << hex << ((pc + 4) & 0xf0000000) + addr * 4; break;
    case 0x03: cout << "jal " << hex << ((pc + 4) & 0xf0000000) + addr * 4; /* jal */ break;
    case 0x04: cout << "beq " << regNames[rs] << ", " << regNames[rt] << ", " << (pc + 4) + (simm << 2);/* beq */ break;
    case 0x05: cout << "bne " << regNames[rs] << ", " << regNames[rt] << ", " << (pc + 4) + (simm << 2);/* bne */ break;
    case 0x09: cout << "addiu " << regNames[rt] << ", " << regNames[rs] << ", " << dec << simm;/* addiu */ break;
    case 0xc: cout << "andi " << regNames[rt] << ", " << regNames[rs] << ", " << dec << simm;/* andi */ break;
    case 0xf:  cout << "lui " << regNames[rt] << ", " << dec << simm;/* lui */ break;
    case 0x1a: cout << "trap " << hex << addr; break;
    case 0x23: cout << "lw " << regNames[rt] << ", " << dec << simm << "(" << regNames[rs] << ")";/* lw */ break;
    case 0x2b: cout << "sw " << regNames[rt] << ", " << dec << simm << "(" << regNames[rs] << ")";/* sw */ break;
    default: cout << "unimplemented";
  }
  cout << endl;
}
