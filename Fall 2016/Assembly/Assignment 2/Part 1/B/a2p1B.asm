##########################################################################
# Daniel Ortiz, CS 2318-001, Assignment 2 Part 1 Program B
##########################################################################
...
main:
		...
		##########################################################
		andi $a1, $v0, 0x84	  # reveal bits 2^2, 2^7 
		li $v0, 4		  # store into $a1	
		la $a0, outLab		   
		syscall
		li $v0, 1		  
		sra $a0, $a1, 2		  # shift arithmatically by 2 bits	
		syscall			  # store into $a0
		##########################################################
