################################################################################
# Name:    Daniel Ortiz
# Class:   CS2318-002 (Assembly Language, Fall 2016)
...
#            intArr[valsToDo - i] = GetOneIntByVal(entIntPrompt);
					addi $a0, $sp, 41
					jal GetOneIntByVal
					addi $a0, $sp, 81	# intArr
					lw  $a1, 77($sp)	# ValsToDo
					sub $a2, $a1, $t1	# ValsToDo - i
					sll $a2, $a2, 2		# Mult by 4
					add $a0, $a0, $a2	# add result to intArr
					sw  $v0, 0($a0)		# store into mem
####################(8)####################
...
#            GetOneIntByAddr(intArr + valsToDo - i, entIntPrompt);
					...
					sub $a2, $a1, $t1	# ValsToDo - i
					sll $a2, $a2, 2		# mult by 4
					add $a0, $a0, $a2	# intArr + result 
					addi $a1, $sp, 41	# entIntPrompt
					jal GetOneIntByAddr	
####################(7)####################
...
#         SwapTwoInts(intArr + i, intArr + j);
					addi $a0, $sp, 81 	# intArr
					sll $a2, $t1, 2		# mult 4 
					addi $a1, $sp, 81	# intArr
					sll $a3, $t2, 2		# mult 4
					add $a0, $a0, $a2	# intArr + i
					add $a1, $a1, $a3	# intArr + j
####################(5)####################
					jal SwapTwoInts
