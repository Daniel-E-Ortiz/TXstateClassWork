...
#                         ProcArrays(mean, a1, a2, a3, used1, &used2, &used3);
					####################(10)####################
					lw   $a0, 28($sp)    # mean arg1
					addi $a1, $sp, 192   # a1   arg2  
					addi $a2, $sp, 240   # a2   arg3
					addi $a3, $sp, 288   # a3   arg4
					lw   $t0, 188($sp)   # used1 value 
					sw   $t0,  16($sp)   # arg5
					addi $t0, $sp, 184   # &used2 ref
					sw   $t0,  20($sp)   # arg 6
					addi $t0, $sp, 180   # &used3 ref
					sw   $t0,  24($sp)   # arg 7			
