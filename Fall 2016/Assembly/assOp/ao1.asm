...
#                       **************************
			...
			# BODY:
#			if (numEle <= 1)
#			if (numEle > 1) goto hasDupEndI1;
			li $v1, 1
			bgt $a1, $v1, hasDupEndI1
#			{
#			   return 0;
			li $v0, 0
			j hasDupEpilog
...
existsEndI1:
#			//if (*arrBegPtr == target)
#			if (*arrBegPtr != target) goto existsEndI2
			lw $v1, 0($a0)
			bne $v1, $a2, existsEndI2
#			{
#			   return 1;
			li $v0, 1
			j existsEpilog
